...
public class GuestManager {
  ...
  */
  ...
  public void addGuest(String firstName, String familyName, String street, String zipCode, String city, Countries country)
  {

    Guest newGuest = new Guest(firstName, familyName, street, zipCode, city, country);
  ...
  public String[] getInfoStrings() {
    ...
    */
    ...
    for (int j = 0; j < guestList.length; j++)
    {
      if (guestList[j] != null)
      {
        System.out.println(guestList[j].getFirstName());
      }
    }
